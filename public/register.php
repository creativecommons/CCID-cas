...
<p class="help-block">However you'd like us to refer to you.</p>
    <input type="password" name="password" class="form-control" placeholder="hunter2" required autocomplete="off">

    <p class="help-block">Your password, which is stored encrypted in our database.</p>
